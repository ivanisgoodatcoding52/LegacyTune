...
- (void)viewWillAppear:(BOOL)animated {
	...
	for (LTSong *song in existing) [ids addObject:[NSNumber numberWithInteger:song.songId]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	cell.accessoryType = [_addedSongIds containsObject:[NSNumber numberWithInteger:song.songId]] ? UITableViewCellAccessoryCheckmark : UITableViewCellAccessoryNone;
	return cell;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if ([_addedSongIds containsObject:songIdNumber]) return;
