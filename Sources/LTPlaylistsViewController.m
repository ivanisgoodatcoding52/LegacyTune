...
- (void)viewDidLoad {
	...
	// This screen is the ROOT of the Playlists tab's nav stack, so there's
	// no automatic Back button here to lose — safe to use leftBarButtonItem
	// for Edit. (Not safe on a PUSHED screen — see LTPlaylistDetailViewController.)
...
- (void)addTapped {
	LTTextPromptViewController *prompt = [[LTTextPromptViewController alloc] initWithTitle:@"New Playlist" placeholder:@"Playlist name" target:self action:@selector(createPlaylistNamed:)];
